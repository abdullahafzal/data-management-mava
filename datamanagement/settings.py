...
# Optional shared secret for POST /api/webhooks/smartlead/ (ngrok / production)
SMARTLEAD_WEBHOOK_SECRET = os.environ.get('SMARTLEAD_WEBHOOK_SECRET', '')
...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-87nntoay#+j^!ygc(nwmjw7(d@h2%rm^iwep#9(ohofonmd8j^',
)
